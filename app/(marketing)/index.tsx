...
import {
  ...
  NotebookText,
  Bookmark,
} from 'lucide-react'; // lucide-react for web
...
const features = [
  {
    ...
    description:
      'Create and manage public, private, or secret book clubs with ease. Invite members, set privacy, and keep your literary circle organized.',
  },
  {
    icon: <Lightbulb className="h-8 w-8 text-primary-dark" />,
    title: 'Dynamic Book Selection',
    description:
      'Suggest new reads to your club, see what others are interested in, and let admins effortlessly pick the next book for discussion.',
  },
  {
    icon: <NotebookText className="h-8 w-8 text-primary-dark" />,
    title: 'Private Notes, Public Discussion',
    description:
      'Jot down your thoughts and questions privately as you read. On meeting day, reveal your insights for a rich, engaging club discussion.',
  },
  {
    icon: <Bookmark className="h-8 w-8 text-primary-dark" />,
    title: 'Personal Reading Journey',
    description:
      "Track books you're currently reading, build your 'want to read' list, and log all your finished books with personal ratings.",
  },
];
        ...
        <main className="flex-1">
          ...
          >
            ...
            <div className="container mx-auto px-4 md:px-6">
              {' '}
              {/* Using div for semantic container */}
                ...
                <div className="flex flex-col justify-center space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="max-w-[600px] text-muted-foreground md:text-xl">
                      BookClub is the perfect place to join book clubs, discuss
                      your favorite reads, and find a community of fellow
                      literature lovers.
                    </p>
                  </div>
                  <div className="flex flex-col gap-2 min-[400px]:flex-row">
                    ...
                    <Link
                      href="/signup"
                      className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 h-10 px-8 py-2 md:h-12 md:px-10 md:py-3
          ...
          <section className="w-full py-12 md:py-24 lg:py-32 bg-card">
            <div className="container mx-auto px-4 md:px-6">
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  <h2 className="text-3xl font-merriweather-bold tracking-tighter sm:text-5xl text-foreground">
                    Why You'll Love BookClub
                  </h2>
                  <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    We've built BookClub to be the ultimate companion for every
                    book lover and book club.
                  </p>
                </div>
              </div>
                ...
                {features.map((feature) => (
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      ...
                      {feature.icon}
                      <h3 className="font-merriweather-bold text-xl mt-4 text-foreground">
                        {feature.title}
                      </h3>
                    </div>
                    <div className="text-center mt-4">
                      {' '}
                      {/* Mimicking CardContent structure */}
